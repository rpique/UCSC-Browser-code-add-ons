...
SQL_USER="-uroot"	# set this to "-u<user_name>" if different than your login name
SQL_PASSWORD="sP7cukuj"	# set this to the MySQL password for the SQL_USER
MySQL_USER=${SQL_USER}
...
#for DB in hgcentral hg19 mm10 mm9 
#do
...
for DB in hgcentral hg19 hgFixed mm10 mm9
do
...
do
    ${MYSQL} -e "GRANT SELECT, CREATE TEMPORARY TABLES on \
	${DB}.* TO browser IDENTIFIED BY 'genome';" mysql
done
